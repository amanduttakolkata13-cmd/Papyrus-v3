/**
 * Papyrus build script — bundles the TypeScript source into a single
...
const result = await Bun.build({
  ...
  define: {
    ...
    'MACRO.PACKAGE_URL': JSON.stringify('papyrus'),
...
console.log(`✓ Built papyrus v${version} → dist/cli.mjs`)
