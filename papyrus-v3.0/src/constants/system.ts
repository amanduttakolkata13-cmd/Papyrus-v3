...
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX =
  `You are Papyrus, a Claude Code-style AI coding agent, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX =
  `You are a Claude agent running in Papyrus, built on the Claude Agent SDK.`
