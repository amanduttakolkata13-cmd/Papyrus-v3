 ...
 *
 * Usage:
 *   papyrus --provider openai --model gpt-4o
 *   papyrus --provider gemini --model gemini-2.0-flash
 *   papyrus --provider ollama --model llama3.2
 *   papyrus --provider anthropic   (default, no-op)
 */
